...
function displayProfiles() {
    ...
    onValue(profilesRef, (snapshot) => {
        ...
        Object.keys(profiles).forEach((key) => {
            ...
            // Trong phần hiển thị danh sách profiles
            const imageCell = row.insertCell(0);
            const imageElement = document.createElement("img");
            imageElement.src = profile.image; // Đặt đường dẫn hình ảnh
            imageCell.appendChild(imageElement); // Thêm thẻ hình ảnh vào ô
            ...
            editIcon.className = "fa-solid fa-pen-to-square"; // Sử dụng class của Font Awesome
            ...
            deleteIcon.className = "fas fa-trash"; // Sử dụng class của Font Awesome
